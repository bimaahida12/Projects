...
<asp:Content ID="ContentMain" ContentPlaceHolderID="MainContent" runat="server">
            <asp:FormView ID="FormViewQuestion" runat="server" AllowPaging="false" ItemType="GoldstoneForum.Models.Question"
            ...
            <div class="questionBoxQuestion">
                ...
                <div class="wellSmall">
                    ...
                    <div class="controls">
                        ...
                        <asp:Button ID="ButtonHideQuestion" runat="server" Text="Hide" CssClass="btn btn-default"
        ...
        <ItemTemplate>
            ...
            <div class="questionBoxFloatless">
                ...
                <div class="wellSmall" runat="server">
                    ...
                    by <span runat="server" class="answer-author"><%#: Item.User.UserName %> </span>
                </div>
            <div class="controls">
                    <div class="btn-group">
                        ...
                        <asp:Button ID="ButtonHideAnswer" runat="server" Text="Hide" CssClass="btn btn-default"
                            Visible="<%# CanUserEditOrRemoveAnswer(Item.Id) %>"
    ...
    <div class="control-group">
        ...
        <%--
        <div class="controls">
            <asp:TextBox runat="server" Rows="5" Width="500px" TextMode="MultiLine" ID="AnswerText" />
        </div>--%>
    </div>
